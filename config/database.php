...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'arkfleet' => [
            'driver' => 'mysql',
            'host' => env('ARKFLEET_DB_HOST', '127.0.0.1'),
            'port' => env('DB_PORT', '3306'),
            'database' => env('ARKFLEET_DB_DATABASE', 'arkfleet'),
            'username' => env('ARKFLEET_DB_USERNAME', 'arkfleet_readonly'),
        ...
        'daily_production' => [
            'driver' => 'mysql',
            'host' => env('DAILY_PRODUCTION_DB_HOST', '127.0.0.1'),
            'port' => env('DB_PORT', '3306'),
            'database' => env('DAILY_PRODUCTION_DB_DATABASE', 'daily_production'),
            'username' => env('DAILY_PRODUCTION_DB_USERNAME', 'daily_production_readonly'),
